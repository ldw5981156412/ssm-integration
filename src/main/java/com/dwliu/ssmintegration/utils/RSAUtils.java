 ...
 *
 * @author dwliu
 * @create-time 2018年5月24日 下午8:32:24
 */
public class RSAUtils {
    ...
    public static PublicKey getPublicKeyByFile(String publicFile) throws Exception  {
        ...
        br.close();
        String key= sb.toString().replace(begin, "").replace(end, "");
        byte[] keyBytes;
        keyBytes = Base64Utils.decode(key);
        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
